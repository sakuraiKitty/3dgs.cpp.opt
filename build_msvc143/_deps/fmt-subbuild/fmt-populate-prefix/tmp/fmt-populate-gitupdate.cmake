...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "9.1.0"
  WORKING_DIRECTORY "D:/liuyue/physDreamerVulkanDemo/3dgs.cpp.opt/build_msvc143/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/liuyue/physDreamerVulkanDemo/3dgs.cpp.opt/build_msvc143/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/liuyue/physDreamerVulkanDemo/3dgs.cpp.opt/build_msvc143/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
